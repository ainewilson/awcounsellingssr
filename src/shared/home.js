...
const Home = () => {
  return (
    <>
      ...
      <h5>Abuse - Sexual, Physical & Emotional</h5>
      <ul>
        <li>Sexual: also referred to as molestation is the forcing of undesired sexual behaviour by one person upon another.</li>
        <li>Physical: is an act of another party involving contact intending to cause physical pain or injury or other physical suffering</li>
        <li>Emotional: often associated with situations with power imbalance in the home or workplace (bullying).</li>
      </ul>

      <p>Effects may result in psychological trauma, including anxiety, chronic depression, or and P.T.S.D.  Always remember that secrets are an abuser’s best friend!</p>

      <h5>Bereavement & Loss</h5>
      <p>Death and loss are a normal part of life, sometimes we need help to cope with these losses and recognise the grieving process at work.</p>

      <h5>Anger Management</h5>
      <p>Anger is a normal emotion, if we didn't have it, we wouldn't know when our boundaries are crossed, it is what we do with anger that causes problems in our lives. Anger is one letter away from D anger</p>

      <h5>Self-Esteem</h5>
      <p>Low self-esteem is at the root of a lot of issues, counselling can help you to see yourself in a more positive light.</p>
