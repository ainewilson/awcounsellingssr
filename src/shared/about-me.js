...
const AboutMe = ({ onClick }) => {
  return (
    <>
      <h5>About me</h5>
      <p>I am an accredited counsellor with the A.C.I.  (Addiction Counsellors of Ireland) and an affiliate member of the I.A.C.P.  (Irish Association for Counselling and Psychotherapy)  and work to their code of ethics.</p>
      <p>From Tuesday the1st of September 2020 I am  returning to  Co. Fermanagh  to work in my home based private practice which is located 8.2 miles from Enniskillen in Maguiresbridge,   Co. Fermanagh - see <a href="/" onClick={ onClick } data-name="contact" >contact</a> page for location.</p>
      <p>It is my intention to bring my Education / Family programme to as many people as possible either in group settings or remotely  via zoom See <a href="/" onClick={ onClick } data-name="family-programme" >Family programme</a> page full details.</p>
      <p>From 2017 to August 2020 I have worked in Smarmore Castle Private Clinic outside Ardee, Co.  Louth supporting patients through their treatment programme and while there was promoted to Specialist Therapist for Family Support.</p>
      <p>From 2013 to 2017 I worked in my private practice outside the village of Rosslea Co. Fermanagh along with working as a sessional counsellor for the following organizations </p>
      ...
      <p>Aisling Centre Enniskillen where I worked as an outreach counsellor for the Probation Service NI.  Doing one to one counselling in the centre and facilitating the Journeying Together Family Support Group every two weeks for family members of all addictions.</p>
